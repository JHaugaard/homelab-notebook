<script lang="ts">
	...
	import { Edit, Trash2, ArrowLeft, FolderOpen, Calendar, Clock, Link2, ArrowUp, Paperclip } from 'lucide-svelte';
	...
	import { formatDate, estimateReadingTime, renderMarkdown } from '$lib/utils';
